...
//		long startTime = System.nanoTime();
		...
		Element g_ID_2 = Function.bytes2element(byte_F_2_ID, "G2", pairing).getImmutable();
		
		//Use F_3 to hash ID
		byte[] byte_F_3_ID = F_3.hash(ID.getBytes());
		Element g_ID_3 = Function.bytes2element(byte_F_3_ID, "G2", pairing).getImmutable();
...
//		long startTime = System.nanoTime();
		...
		Element F_2_ID = Function.bytes2element(byte_F_2, "G2", pairing).getImmutable();
		...
		//Compute C_2
		Element h_m_r = Function.bytes2element(byte_m, "G2", pairing);
		h_m_r.powZn(r);
		...
		Element F_3_ID = Function.bytes2element(byte_F_3, "G2", pairing).getImmutable();
...
//		long startTime = System.nanoTime();
		...
		//Check equation 
		Element h_m = Function.bytes2element(m, "G2", pairing);
...
//			System.out.print(String.format("%.2f", (float)((endTime - startTime) / 1_000_000.0000))+ " ");
	...
	private static Element compute(Map<String, Object> pk, Map<String, Object> ct, Map<String, Object> td, Pairing pairing) {
		...
		Element res = Function.bytes2element(delta, "G2", pairing).getImmutable();
